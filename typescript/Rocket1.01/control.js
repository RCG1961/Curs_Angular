...
/* @ts-ignore */
var cohete2 = document.getElementById("cohete2");
...
function createRocket1() {
    /* @ts-ignore */
    var buton_m1 = document.getElementById("crear1").textContent;
    switch (buton_m1) {
        case 'CREAR':
            /* @ts-ignore */
...
function createRocket2() {
    /* @ts-ignore */
    var buton_m2 = document.getElementById("crear2").textContent;
    switch (buton_m2) {
        case 'CREAR':
            /* @ts-ignore */
...
function showRocket2Info() {
    var potmax2 = 0;
    for (var i = 0; i < (rocket2.PropulsoresArray.length); i++) {
        potmax2 += rocket2.PropulsoresArray[i].PropulsorPower;
    }
...
function maximaPropulsion(oneArr) {
    var Datos = "";
